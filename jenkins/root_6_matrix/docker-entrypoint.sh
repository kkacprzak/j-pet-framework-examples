...
executeCommand "cd j-pet-framework/"
...
executeCommand "cmake .."
executeCommand "make"
executeCommand "make tests_commontools"
executeCommand "make tests_imagereconstruction"
executeCommand "make tests_listmodeexport"

executeCommand "cd ImageReconstruction"
executeCommand "ctest -j6 -C Debug -T test --output-on-failure"
executeCommand "cd .."

executeCommand "cd CommonTools"
executeCommand "ctest -j6 -C Debug -T test --output-on-failure"
executeCommand "cd .."

executeCommand "cd ListmodeExport"
executeCommand "ctest -j6 -C Debug -T test --output-on-failure"
executeCommand "cd .."
