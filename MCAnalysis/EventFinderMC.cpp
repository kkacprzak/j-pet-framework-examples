...
EventFinderMC::EventFinderMC(const char* name) : JPetUserTask(name) {}

EventFinderMC::~EventFinderMC() {}

bool EventFinderMC::init()
{
...
bool EventFinderMC::terminate()
{
  INFO("Event fiding ended.");
  return true;
}

void EventFinderMC::saveEvents(const vector<JPetEvent>& events)
{
 ...
 */
vector<JPetEvent> EventFinderMC::buildEvents(const JPetTimeWindow& timeWindow)
{
  vector<JPetEvent> eventVec;
...
void EventFinderMC::initialiseHistograms()
{
